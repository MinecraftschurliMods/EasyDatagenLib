...
/// The abstract parent class of builder classes used by [AbstractCompatHandler] for generating data contents.
public abstract class AbstractDataBuilder<T extends AbstractDataBuilder<T>> {
    ...
    /// Adds this builder's contents to the given [JsonObject].
