...
/**
 * The abstract parent class of builder classes used by {@link AbstractRecipeCompatHandler} for generating recipes.
 */
public abstract class AbstractRecipeBuilder<T extends AbstractRecipeBuilder<T>> extends AbstractDataBuilder<T> {
     ...
     */
    public AbstractRecipeBuilder(Identifier id, AbstractRecipeCompatHandler<T> provider) {
        super(id, provider);
    }
