...
public class TranslatedEntryBuilder extends EntryBuilder<TranslatedBookBuilder, TranslatedCategoryBuilder, TranslatedEntryBuilder> {
    ...
    @Override
    public TranslatedEntryBuilder addSimpleImagePage(Identifier image, String text, String title) {
    ...
    @Override
    public TranslatedEntryBuilder addSimpleMultiblockPage(String name, String text, Identifier multiblock) {
        String key = getLangKey(pageCount());
