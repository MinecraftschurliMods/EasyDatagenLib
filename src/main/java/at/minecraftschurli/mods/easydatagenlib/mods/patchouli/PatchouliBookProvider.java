...
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.regular.RegularBookBuilder;
...
public abstract class PatchouliBookProvider implements DataProvider {
    ...
    private CompletableFuture<?> saveEntry(CachedOutput cache, JsonObject json, Identifier bookId, Identifier id, String locale) {
    ...
    private CompletableFuture<?> saveCategory(CachedOutput cache, JsonObject json, Identifier bookId, Identifier id, String locale) {
    ...
    public RegularBookBuilder createBookBuilder(String id, String name, String landingText, HolderLookup.Provider registries) {
        return new RegularBookBuilder(Identifier.fromNamespaceAndPath(this.namespace, id), name, landingText, this, registries);
    }
