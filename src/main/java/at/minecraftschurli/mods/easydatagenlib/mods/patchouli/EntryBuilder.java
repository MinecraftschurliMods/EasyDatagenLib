...
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.EmptyPageBuilder;
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.EntityPageBuilder;
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.ImagePageBuilder;
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.LinkPageBuilder;
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.MultiblockPageBuilder;
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.RecipePageBuilder;
import at.minecraftschurli.mods.easydatagenlib.mods.patchouli.page.SpotlightPageBuilder;
...
public abstract class EntryBuilder<B extends BookBuilder<B, C, E>, C extends CategoryBuilder<B, C, E>, E extends EntryBuilder<B, C, E>> {
    ...
    public E addSimpleImagePage(Identifier image, String text, String title) {
    ...
    public E addSimpleRecipePage(String type, Identifier recipe) {
        return this.addSimpleRecipePage(type, recipe, null, null);
    }

    public E addSimpleRecipePage(String type, Identifier recipe, String text) {
        return this.addSimpleRecipePage(type, recipe, text, null);
    }

    public E addSimpleRecipePage(String type, Identifier recipe, String text, String title) {
        return this.addRecipePage(type, recipe, text, title).build();
    }

    public E addSimpleDoubleRecipePage(String type, Identifier recipe1, Identifier recipe2) {
        return this.addSimpleDoubleRecipePage(type, recipe1, recipe2, null, null);
    }

    public E addSimpleDoubleRecipePage(String type, Identifier recipe1, Identifier recipe2, String text) {
        return this.addSimpleDoubleRecipePage(type, recipe1, recipe2, text, null);
    }

    public E addSimpleDoubleRecipePage(String type, Identifier recipe1, Identifier recipe2, String text, String title) {
        return this.addRecipePage(type, recipe1, text, title).setRecipe2(recipe2).build();
    }

    public RecipePageBuilder addRecipePage(String type, Identifier recipe, String text, String title) {
    ...
    public RecipePageBuilder addRecipePage(String type, Identifier recipe) {
        return this.addPage(new RecipePageBuilder(Identifier.fromNamespaceAndPath("patchouli", type), recipe, this));
    }
    ...
    public E addSimpleMultiblockPage(String name, Identifier multiblock) {
        return this.addMultiblockPage(name, multiblock).build();
    }

    public E addSimpleMultiblockPage(String name, String text, Identifier multiblock) {
        return this.addMultiblockPage(name, multiblock).setText(text).build();
    }

    public MultiblockPageBuilder addMultiblockPage(String name, Identifier multiblock) {
    ...
    public E setAdvancement(AdvancementHolder advancement) {
        return this.setAdvancement(advancement.id());
    }

    public E setAdvancement(Identifier advancement) {
