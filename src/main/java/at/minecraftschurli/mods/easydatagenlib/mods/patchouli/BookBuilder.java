...
public abstract class BookBuilder<B extends BookBuilder<B, C, E>, C extends CategoryBuilder<B, C, E>, E extends EntryBuilder<B, C, E>> {
    ...
    private Identifier flipSound;
    private Boolean showProgress;
    private String indexIcon;
    private String version;
    private String subtitle;
    private Identifier creativeTab;
    private Identifier advancementsTab;
    private Boolean dontGenerateBook;
    private String customBookItem;
    private Boolean showToasts;
    private Boolean i18n;

    protected BookBuilder(Identifier id, String name, String landingText, PatchouliBookProvider provider, HolderLookup.Provider registries) {
        this.id = id;
    ...
    public B setBookTexture(Identifier bookTexture) {
    ...
    public B setModel(Identifier model) {
    ...
    public B setOpenSound(Identifier openSound) {
    ...
    public B setFlipSound(Identifier flipSound) {
    ...
    public B setCreativeTab(Identifier creativeTab) {
        this.creativeTab = creativeTab;
        return this.self();
    }

    public B setAdvancementsTab(Identifier advancementsTab) {
