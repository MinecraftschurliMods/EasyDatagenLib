...
public abstract class DisplayState implements JsonSerializable {
    ...
    public static class Simple extends DisplayState {
        private static final Identifier ID = Identifier.fromNamespaceAndPath("botanypots", "simple");
    ...
    public static class Transitional extends DisplayState {
        private static final Identifier ID = Identifier.fromNamespaceAndPath("botanypots", "transitional");
