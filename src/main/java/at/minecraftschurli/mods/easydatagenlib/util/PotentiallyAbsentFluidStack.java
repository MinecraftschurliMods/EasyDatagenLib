...
/// It contains a fluid id in [Identifier] form, an amount and an optional [CompoundTag].
/// When serializing to JSON, no [FluidStack] will be used. Instead, the correct JSON syntax is recreated by hand.
...
public class PotentiallyAbsentFluidStack implements JsonSerializable {
    ...
    /// Variant of [PotentiallyAbsentFluidStack] that adds extra chance info.
